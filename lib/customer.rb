class Customer
  ...
  def initialize(order)
    ...
    self.delivery_country_code = delivery_address.country
    self.invoice_country_code  = invoice_address.country
  ...
  def set_taxes_for_customer
    # Normale kunden 19%
    # Firmen auch
    # Schweiz , Oesterreich usw wird nicht besteuert.
    # TODO
  end
